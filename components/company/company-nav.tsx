...
import { Briefcase, LayoutDashboard, FileText, LogOut, Menu, Home } from "lucide-react"
    ...
    <header className="border-b glass sticky top-0 z-50 shadow-brand backdrop-blur-md animate-fade-in">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 animate-slide-in-right">
          <Link href="/">
            <Button variant="ghost" size="sm" className="gap-2 btn-enhanced hover-lift hidden md:flex">
          ...
          <LanguageSwitcher />
          <Button variant="ghost" size="sm" onClick={handleLogout} className="gap-2 btn-enhanced hover-lift hidden md:flex">
